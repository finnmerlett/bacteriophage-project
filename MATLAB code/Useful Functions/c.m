function varargout = c(x, varargin)

% out = c(x, varargin)
% 
% Invoke c brackets operator for x, passing in all further arguments.
...
% 
% >> c({'soup', 1, [1 1 3 5 8 13]}, 1)
% ans =
% soup
%
% We can select a random index.
%
% >> c({'soup', 1, [1 1 3 5 8 13]}, randi(3))
% ans =
%      1     1     3     5     8    13
%
% We can select multiple indices.
%
% >> [thing_1, thing_2] = c({'soup', 1, [1 1 3 5 8 13]}, 1:2)
% thing_1 =
% soup
% thing_2 =
%      1
...
%
% >> [thing_1, thing_2, thing_3] = c({'soup', 1, [1 1 3 5 8 13]}, ':')
% thing_1 =
% soup
% thing_2 =
%      1
